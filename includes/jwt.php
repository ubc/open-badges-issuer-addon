...
class JWT {
	 ...
	 * @param string $method       The signing algorithm. Supported algorithms are 'HS256', 'HS384', 'HS512' and 'RS256'
	...
	private static function _handleJsonError( $errno ) {
		throw new DomainException( isset( self::$messages[ $errno ] ) ? self::$messages[ $errno ] : 'Unknown JSON error: ' . $errno );
	}
